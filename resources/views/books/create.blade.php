                        ...
                        <form method="POST" action="{{ route('books.store') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="{{ __("Enter Book's Title") }}." value="{{ old('title') }}">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="number" min="1" max="99999" class="form-control @error('pages')is-invalid @enderror" id="pages" name="pages" placeholder="{{ __("Enter Book Page Count") }}" value="{{ old('pages') }}">
                                    <hr class="input-hover-effect">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('isbn') is-invalid @enderror" id="isbn" name="isbn" placeholder="{{ __("Enter Book's ISBN Code") }}." value="{{ old('isbn') }}">
                                <hr class="input-hover-effect">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('short_desc') is-invalid @enderror" id="short_desc" name="short_desc" placeholder="{{ __("Enter Book's Description") }}." value="{{ old('short_desc') }}">
                                <hr class="input-hover-effect">
